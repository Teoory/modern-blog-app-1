...
const AdminPage = () => {
  ...
  useEffect(() => {
    fetch('https://fiyasko-blog-app.vercel.app/users', {
      method: 'GET',
      credentials: 'include',
    })
    ...
    fetch('https://fiyasko-blog-app.vercel.app/previevPost', {
      method: 'GET',
      credentials: 'include',
    })
    .then(response => response.json())
  ...
  const handleChangeTag = (username, newTag) => {
    fetch('https://fiyasko-blog-app.vercel.app/changeTag', {
      method: 'POST',
      headers: {
  ...
  function handleWarning(ev) {
    ...
    fetch('https://fiyasko-blog-app.vercel.app/warning', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
