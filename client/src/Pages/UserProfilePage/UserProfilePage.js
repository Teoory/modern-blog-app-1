...
const UserProfilePage = () => {
  ...
  useEffect(() => {
    fetch(`https://fiyasko-blog-app.vercel.app/profile/${username}`)
  ...
  useEffect(() => {
      ...
      fetch(`https://fiyasko-blog-app.vercel.app/profile/${username}/likedPosts`)
    .then(response => response.json())
    .then(data => {
                ...
                {userInfo.username === username ?
                    <form onSubmit={newProfilePhoto} id="profilePhotoForm">
                      <div className="ppContent">
                        ...
                        {profilePhoto && (
                          // <img src={`https://fiyasko-blog-app.vercel.app/${user.profilePhoto}`} alt="Profile" />
              ...
              <div className='LastPostImage'>
                  ...
                  <div key={post._id} className="LastPostImageOverlay">
                      <Link to={`/post/${post._id}`} className='BlogTitle'>
                          {/* <img src={'https://fiyasko-blog-app.vercel.app/'+post.cover} alt="img" /> */}
