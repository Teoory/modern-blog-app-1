...
const PrevievPostPage = () => {
    ...
    const {id} = useParams();
    useEffect(() => {
        fetch(`https://fiyasko-blog-app.vercel.app/previevPost/${id}`).then(response => {
    ...
    const approvePost = async () => {
        try {
            const response = await fetch(`https://fiyasko-blog-app.vercel.app/approvePost/${postInfo._id}`, {
                method: 'PUT',
                headers: {
    ...
    const deletePost = async () => {
        try {
            const response = await fetch(`https://fiyasko-blog-app.vercel.app/previevPost/${postInfo._id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
